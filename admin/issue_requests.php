        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        <center>
                        <a href="issue_requests.php" class="btn btn-info">Yêu cầu phát hành</a>
                        <a href="renew_requests.php" class="btn btn-info">Yêu cầu gia hạn</a>
                        <a href="return_requests.php" class="btn btn-info">Yêu cầu trả lại</a>
                        </center>
                        <h1><i>Yêu cầu phát hành</i></h1>
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center>
                                        <?php
                                        if($avail > 0)
                                        {echo "<a href=\"accept.php?id1=".$bookid."&id2=".$rollno."\" class=\"btn btn-success\">Chấp Nhận </a>";}
                                         ?>
